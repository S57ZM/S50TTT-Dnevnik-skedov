...
`1.15.0-alpha`. Vpisani testni podatki nikoli ne končajo v produkcijski bazi.
...
zaščito prijave pred ponavljajočim ugibanjem gesel.
...
```json
{"channel":"alpha","status":"ok","version":"1.15.0-alpha"}
```
