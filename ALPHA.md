...
`1.25.2-alpha`. Vpisani testni podatki nikoli ne končajo v produkcijski bazi.
...
```json
{"channel":"alpha","database":"ok","schema_latest":3,"schema_version":3,"status":"ok","version":"1.25.2-alpha"}
```
