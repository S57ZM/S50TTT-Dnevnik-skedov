...
def edit_net(net_id):
    ...
    if request.method == "POST":
        ...
        if ended_at < started_at:
            flash("Končna ura ne sme biti pred začetno uro.", "danger")
            return redirect(request.url)
